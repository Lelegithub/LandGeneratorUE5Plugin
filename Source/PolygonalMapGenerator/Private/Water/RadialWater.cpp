...
#include "RadialWater.h"

URadialWater::URadialWater()
{
	Bumps = 3;
	StartAngle = 1.0f;
	AngleOffset = 1.0f;
...
bool URadialWater::IsPointLand_Implementation(FPointIndex Point, UTriangleDualMesh* Mesh, const FVector2D& HalfMeshSize, const FVector2D& Offset, const FIslandShape& Shape) const
{
